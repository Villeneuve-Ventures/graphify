...
"$(cat graphify-out/.graphify_python)" -E -P -B -m graphify trae install       # or: "$(cat graphify-out/.graphify_python)" -E -P -B -m graphify trae-cn install
```
...
"$(cat graphify-out/.graphify_python)" -E -P -B -m graphify trae uninstall     # or: "$(cat graphify-out/.graphify_python)" -E -P -B -m graphify trae-cn uninstall   # remove the section
```
