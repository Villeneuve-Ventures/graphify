...
def _run_cli() -> None:
    ...
    if len(sys.argv) < 2 or sys.argv[1] in ("-h", "--help", "-?"):
        ...
        print("  transaction gc --output DIR --device D --inode I --workspace PATH")
        print("                            --workspace-device D --workspace-inode I [--apply]")
        print("                            dry-run or remove one proven retired workspace")
