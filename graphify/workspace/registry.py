...
class RegistryStore:
    ...
    def _assert_source_binding_available(
        ...
        source: SourceIdentity,
        *,
        allow_same_workspace_common: bool = False,
    ) -> None:
        for entry in entries:
            ...
            if any(
                ...
                or (item["git_common_dir"] == source.registry_source["git_common_dir"]
                    and not (allow_same_workspace_common and entry["repo_uuid"] == source.repo_uuid))
    ...
    def adopt(
        ...
        *,
        ...
        with self.exclusive_lock():
            ...
            self._assert_source_binding_available(
                entries, source, allow_same_workspace_common=True,
            )
