...
keeps package-local bytecode caches and user-site imports outside the trusted
runtime path. The installed-root/no-follow, mode, size, digest, hard-limit,
