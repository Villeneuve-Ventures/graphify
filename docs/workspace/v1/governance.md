...
Ledger refresh: `2026-08-23T21:57:56Z`
...
|---|---|
| Canonical implementation | At `2026-08-23T21:57:56Z`, repository-qualified `Villeneuve-Ventures/graphify@workspace/v1` resolved to PR [#83](https://github.com/Villeneuve-Ventures/graphify/pull/83)'s normal merge `2ba0abcad54fcaaeb9127564c0d1c9d0965750ab`, tree `e4838ebac9e07481bb139e4ae330ea34a9f2c338`. Its ordered parents are base `2328f2bf3f5497482accf224ab1320688a43e706` and repair head `17bd783cd7707ea34c7d8f831391d80415a17059`. The local `workspace/v1` checkout remains clean at the earlier `2328f2bf3f5497482accf224ab1320688a43e706`, tree `1bceb12785ec5f520af189568c1f28c03eda2ba1`, and is not used as current canonical proof. |
| Staged PR #81 documentation candidate | Draft PR [#81](https://github.com/Villeneuve-Ventures/graphify/pull/81) remains open and unmerged at head `dba72899df4d4d9970d65f1f40639ef453058e8a`, tree `cceff46c4f0284949e98649ab3ba873f8760d399`, based on `c54c6116a45cf026546579b2fd6421fbad6dcf74`. The task worktree contains only the staged nine-Markdown-path governance candidate; its final combined digest is reported outside the receipt after independent review. It is not canonical implementation evidence. |
| Worktrees | Three proven worktrees exist: the clean local `workspace/v1` checkout at `2328f2bf3f5497482accf224ab1320688a43e706`, the intentionally dirty PR #81 documentation worktree at `dba72899df4d4d9970d65f1f40639ef453058e8a`, and the clean retained PR #83 repair worktree at `17bd783cd7707ea34c7d8f831391d80415a17059`. This staged closeout authorizes no cleanup, rebase, force-push, merge, or other worktree/ref mutation. |
| GitHub | PR #83 is the latest merge to `workspace/v1`. Exact-head CI [32657311665](https://github.com/Villeneuve-Ventures/graphify/actions/runs/32657311665) passed `skillgen-check`, `test (3.14)`, and `security-scan`; ready-triggered PR Agent [32663886361](https://github.com/Villeneuve-Ventures/graphify/actions/runs/32663886361) passed `review`; CodeRabbit completed without actionable comments. PR #83 has no submitted GitHub reviews and zero review threads. PR #81 remains draft, mergeable, and `CLEAN` at its unchanged head, with five current unresolved review threads. Review UI state was inspected read-only, was not treated as technical proof, and was not mutated. GitHub Issues are disabled. |
