...
Non-English locale codes are reserved as README parent-directory names, even for
English text; use descriptive topic names such as `operating-systems` instead of
