...
@pytest.mark.parametrize(
    ...
    [
        ...
        (b"Authorization: Basic dTpw \nordinary", "secret.authorization_credential"),
        (
        ...
        (b"password=p", "secret.credential_assignment"),
        (b"secret=abc123", "secret.credential_assignment"),
        ...
        (b"x://u:p@example.test", "secret.credential_uri"),
