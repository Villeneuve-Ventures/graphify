...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("registry.json", REGISTRY_REMOTE_URL_PATH, "ssh://user name@example.com/a"),
        ("registry.json", REGISTRY_REMOTE_URL_PATH, "ssh://user?x@example.com/a"),
        ("registry.json", REGISTRY_REMOTE_URL_PATH, "ssh://user#x@example.com/a"),
        ("registry.json", REGISTRY_REMOTE_URL_PATH, "ssh://u[v@example.com/a"),
        ("registry.json", REGISTRY_REMOTE_URL_PATH, "ssh://u]v@example.com/a"),
        ("registry.json", REGISTRY_REMOTE_URL_PATH, "ssh://@example.com/a"),
